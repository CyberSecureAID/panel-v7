...
const I18N = {
  en: {
    ...
    inputLbl:'You receive', minLabel:'Min. 25,000 tokens',
    youPayLbl:'You pay', priceLbl:'Price per token',
    slipLbl:'Slippage tolerance', minNote:'Minimum purchase: 25,000 USDT.z',
    ...
    minErr:'Minimum purchase is 25,000 tokens.',
  ...
  es: {
    ...
    inputLbl:'Recibes', minLabel:'Mín. 25.000 tokens',
    youPayLbl:'Pagas', priceLbl:'Precio por token',
    slipLbl:'Tolerancia slippage', minNote:'Compra mínima: 25.000 USDT.z',
    ...
    minErr:'La compra mínima es 25.000 tokens.',
