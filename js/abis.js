...
/** Minimal ERC-20 ABI (balanceOf, transfer, approve, allowance, decimals)
 *  [FIX] Faltaba `transfer`. Sin esa entrada en el ABI, web3 NO crea el
 *  método y `tokenC.methods.transfer(...)` era undefined: de ahí el error
 *  "tokenC.methods.transfer is not a function" al depositar tokens. */
const ERC20_ABI = [
